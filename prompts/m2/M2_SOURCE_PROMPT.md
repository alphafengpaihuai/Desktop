# M2 辨证选方模块 — 源提示词 v1（已废弃）

> ⚠ **DEPRECATED — 2026-06-06**
>
> 本文件是 v1 Prompt-First 方案，已由 `docs/m2_source_prompt_v2_code_first.md`（v2 Code-First 方案）替代。
>
> **废弃原因**：v1 假设 LLM 为主裁判，但实际系统设计已正式调整为 Code-First 方案，
> M2-1 使用代码评分器为主，LLM 仅做低置信兜底/解释/平局裁决。
>
> **迁移路径**：
> - 新代码应以 v2 spec 为准
> - 所有 M2-1 审计/测试应参考 v2，不再以 v1 为标准
> - v1 中的禁止项（如禁止 confidence/trace 输出）在 v2 中被重新允许（作为 internal/debug 字段）
> - v1 中的强制项（如必须 LLM 做主裁判）已被 v2 废弃
>
> ---
>
> ## 旧版标题（保留供历史参考）

# M2 辨证选方模块 — 源提示词（Prompt-First 母版）[DEPRECATED]
